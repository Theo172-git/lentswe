...
const contactInfo = [
  {
    ...
    details: ["4 Kuerboom Street", "Geelhoutpark, Rustenburg, 0300", "North West Province, South Africa"],
  },
  {
    icon: Phone,
    title: "Phone Number",
    gradient: "from-rose-500 to-pink-600",
    details: ["+27 65 879 5912"],
    links: ["tel:+27658795912"],
  },
  {
    icon: Mail,
    title: "Email Addresses",
    gradient: "from-violet-500 to-purple-600",
    details: ["Info@Lentsweholding.com", "Accounts@Lentsweholding.com"],
    links: ["mailto:Info@Lentsweholding.com", "mailto:Accounts@Lentsweholding.com"],
  },
  {
    icon: Clock,
